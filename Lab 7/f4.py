...
def check_eqn_balance(reactants, products):
    ...
    # TODO your code here
    # Start by extracting useful information
    ...
    # Next, get the dictionary representation of the atoms on both sides
    ...
    # print(reactants_coefficients, reactants)


    for formula in string_form_products_tuple:
        products.append(mol_form(formula))
    products = tuple(products)
    # print(products_coefficients, products)


    reactants_expr_form = expr_form(reactants_coefficients, reactants)
    # print(reactants_expr_form)

    products_expr_form = expr_form(products_coefficients, products)
    # print(products_expr_form)

    # Finally, check if both dictionaries have the same key-value pairs
    unbalanced = find_unbalanced_atoms(products_expr_form, reactants_expr_form)
    return unbalanced


check_eqn_balance(((1,5), ("C3H8","O2")),((4,3), ("H2O","CO2")))
print(check_eqn_balance(((1, 2), ("C3H8", "O2")), ((4, 3), ("H2O", "CO2"))))
print(check_eqn_balance(((1,5), ("C3H8","O2")),((4,3), ("H2O","CO2"))))
