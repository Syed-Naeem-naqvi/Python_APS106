...
for i in range(100000):
    ...
    my_deck = shuffle(my_deck)
    res = play(my_deck)
    lots_of_games.append(res)

dealer_wins = 0
player_wins = 0

for match in lots_of_games:
    if match[0] == 'dealer wins':
        dealer_wins += 1
    elif match[0] == 'player wins':
        player_wins += 1

print(player_wins, dealer_wins)

""" OUTDATED
Each trial value was found for a session of 100,000 games
Trial01: p = 40.448%, d = 59.552%
Trial02: p = 40.697%, d = 59.303%
Trial03: p = 40.511%, d = 59.489%
Trial04: p = 40.239%, d = 59.761%
Trial05: p = 40.356%, d = 59.644%
Trial06: p = 40.653%, d = 59.347%
Trial07: p = 40.391%, d = 59.609%
Trial08: p = 40.354%, d = 59.646%
Trial09: p = 40.463%, d = 59.537%
Trial10: p = 40.570%, d = 59.430%
"""